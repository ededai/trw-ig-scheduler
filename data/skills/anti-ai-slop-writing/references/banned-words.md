...
- **Double dash** (--) — NEVER. Not once. Always rewrite.
- **Em dash** (—) — Maximum one per 500 words, only when truly necessary. Not as a lazy comma substitute. When in doubt, rewrite instead.
